      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $pro->slug }}</td>
            <td>{{ $pro->price }}</td>
            <td><img src="{{URL::to('/uploads/product/'.$pro->image) }}" height="100" width="100"></td>
            <td>{{ $pro->name_cate }}</td>
            ...
            <td>
              <a href="{{URL::to('/detail-product/'.$pro->id)}}" class="active styling-edit" ui-toggle-class="">
                <i class="fa fa-eye text-success text-active"></i></a>
              <a href="{{URL::to('/edit-product/'.$pro->id)}}" class="active styling-edit" ui-toggle-class="">
                <i class="fa fa-pencil-square-o text-success text-active"></i></a>
                <a href="{{URL::to('/comment-product/'.$pro->id)}}" class="active styling-edit" ui-toggle-class="">
