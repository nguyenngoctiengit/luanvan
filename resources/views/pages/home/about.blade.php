<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBSH3s9_g7TZRuwAmB8MzLd8lul5AXp2yg">
</script>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-10">
                            <div class="about-image-wrap">
                                <img class="img-full" src="{{URL::to('/frontend/images/about-us/banner-balo-gaming-jpeg.jpg')}}" alt="About Us" />
                            </div>
                        </div>
                        <!-- About Image End -->
                    </div>
                    ...
                    <div class="row no-gutters">
                            ...
                            <div class="limupa-counter white-smoke-bg">
                                <div class="container">
                                    <div class="counter-img">
                                        <img src="{{URL::to('/frontend/images/about-us/icon/1.png')}}" alt="">
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="limupa-counter gray-bg">
                                <div class="counter-img">
                                    <img src="{{URL::to('/frontend/images/about-us/icon/2.png')}}" alt="">
                                </div>
                                <div class="counter-info">
                                    <div class="counter-number">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="limupa-counter white-smoke-bg">
                                <div class="counter-img">
                                    <img src="{{URL::to('/frontend/images/about-us/icon/3.png')}}" alt="">
                                </div>
                                <div class="counter-info">
                                    <div class="counter-number">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="limupa-counter gray-bg">
                                <div class="counter-img">
                                    <img src="{{URL::to('/frontend/images/about-us/icon/4.png')}}" alt="">
                                </div>
                                <div class="counter-info">
                                    <div class="counter-number">
                                        <h3 class="counter">2169</h3>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member mb-60 mb-sm-30 mb-xs-30">
                                <div class="team-thumb">
                                    <img src="{{URL::to('/frontend/images/team/1.png')}}" alt="Our Team Member">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member mb-60 mb-sm-30 mb-xs-30">
                                <div class="team-thumb">
                                    <img src="{{URL::to('/frontend/images/team/2.png')}}" alt="Our Team Member">
                                </div>
                                <div class="team-content text-center">
                                    <h3>Oliver Bastin</h3>
                                    <p>Web Designer</p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member mb-30 mb-sm-60">
                                <div class="team-thumb">
                                    <img src="{{URL::to('/frontend/images/team/3.png')}}" alt="Our Team Member">
                                </div>
                                <div class="team-content text-center">
                                    <h3>Erik Jonson</h3>
                                    <p>Web Developer</p>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="team-member mb-30 mb-sm-60 mb-xs-60">
                                <div class="team-thumb">
                                    <img src="{{URL::to('/frontend/images/team/4.png')}}" alt="Our Team Member">
                                </div>
                                <div class="team-content text-center">
                                    <h3>Maria Mandy</h3>
...
<script type="text/javascript">
    ...
    function initMap() {
      var myOptions = {
           zoom: 15,
           center: new google.maps.LatLng(10.7389156,106.6777549),
           mapTypeId: google.maps.MapTypeId.ROADMAP
       };
       map = new google.maps.Map(document.getElementById('google-map'), myOptions);
       marker = new google.maps.Marker({
           map: map,
           position: new google.maps.LatLng(10.7389156,106.6777549)
       });
       infowindow = new google.maps.InfoWindow({
           content: '<img src="'+url_asset+'/frontend/images/about-us/logo.jpg" alt="" style="width:90px; "><div>Trường Đại Học Công Nghệ Sài Gòn</div>'
       });
