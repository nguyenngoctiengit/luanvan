                            ...
                            <div class="category-menu">
                                ...
                                <div id="cate-toggle" class="category-menu-list">
                                    <ul>
                                        ...
                                        @if($i<8)
                                        <li><a href="{{URL::to('/'.$value->slug)}}">{{$value->name}}</a></li>
                                        @else
                                        <li class="rx-child"><a href="{{URL::to('/'.$value->slug)}}">{{$value->name}}</a></li>
                                        @endif
                                        <?php $i++;?>
                                        @endforeach
                                        </li>
                        ...
                        <div class="col-lg-9">
                            <div class="slider-area pt-sm-30 pt-xs-30">
                                <div class="slider-active owl-carousel">
                                    ...
                                    <a href="{{URL::to($value->slug_pro)}}" class="single-slide align-center-left animation-style-01 bg-7" style="background-image:url({{asset('/uploads/banner/'.$value->image_banner)}})">
                                    @elseif($value->id_news!=null)
                                    <a href="{{URL::to('tin-tuc/'.$value->slug_new)}}" class="single-slide align-center-left animation-style-01 bg-7" style="background-image:url({{asset('/uploads/banner/'.$value->image_banner)}})">
                                        @elseif($value->id_km!=null)
                                         <a href="{{URL::to('/'.$value->slug_km)}}" class="single-slide align-center-left animation-style-01 bg-7" style="background-image:url({{asset('/uploads/banner/'.$value->image_banner)}})">
                                    @endif
