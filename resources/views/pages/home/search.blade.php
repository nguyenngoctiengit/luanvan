...
@section('content') 
<div class="container">
    <h1 style="margin-top: 50px;font-size: 24px;font-weight: bold;">Tìm kiếm với từ khóa: {{$keywords}}</h1>
</div>

<div style="margin-left: 100px;margin-top: 30px">
    <form method="get" action="{{route('get.search')}}">
         <input type="hidden" name="keywords_submit" value="{{$keywords}}">
        <div class="row">
            <label class="title-label">Danh mục:</label>
            <div class="col-lg-2">
                <select style="height: unset;" name="cate_select" class="price-select nice-select wide method">
                    <option value="0">All</option>
                    @foreach($cate as $item)
                    @if($cate_select!=null)
                    @if($item->id==$cate_select)
            ...
            <div class="col-lg-2">
                <select name="price_select" class="price-select nice-select wide method">
            ...
            <div class="col-lg-2">
                <select name="orderby" class="orderby nice-select wide method">
                   @if($orderby!=null)
